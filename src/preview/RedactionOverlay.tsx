          ...
          return (
            ...
            >
              <path
                ...
                className={`pointer-events-auto ${open ? 'text-blue-300' : 'text-blue-300/45'}`}
                onPointerDown={(e) => {
                  e.stopPropagation();
        ...
        return (
          <div
            ...
            className={`pointer-events-auto absolute touch-none border-2 border-dashed ${stroke} ${
              open ? 'cursor-move bg-blue-400/5' : 'cursor-pointer'
          ...
          >
            {open &&
              (['nw', 'ne', 'sw', 'se'] as const).map((corner) => (
                <div
                  key={corner}
                  className={`absolute h-3 w-3 rounded-sm border border-zinc-900 bg-blue-300 shadow ${
