    ...
    <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 h-3">
      {times.map((time) => (
        <button
          ...
          className={`pointer-events-auto absolute bottom-0.5 -translate-x-1/2 rotate-45 rounded-[1px] border border-zinc-900 bg-zinc-100 shadow cursor-ew-resize touch-none hover:bg-brand-200 active:bg-brand-300 ${size}`}
