...
export function ClipFades({
  ...
  return (
    <>
      ...
      {xfadeInMs > 0 && (
        <div
          className="pointer-events-none absolute inset-y-0 left-0 border-r border-blue-300/50 bg-blue-300/10"
      ...
      {xfadeOutMs > 0 && (
        <div
          className="pointer-events-none absolute inset-y-0 right-0 border-l border-blue-300/50 bg-blue-300/10"
